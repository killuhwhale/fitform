...
const HorizontalPicker: FunctionComponent<{ data: string[], onChange(idx: number) }> = (props) => {
    ...
    const eventHandler = useAnimatedGestureHandler({
        ...
        onEnd: (event, ctx) => {
            ...
            try{
                ...
                const rawVal = totalDistMoved / (sharedItemWidth.value == 0? 1: sharedItemWidth.value)
    ...
    const sref = useRef( <Animated.View
    ...
    return (
        <View style={{ flex: 1, width: '100%' }} onLayout={getWidthLayout}>
            ...
            <MaskedView style={{ flex: 1, height: '100%', flexDirection: 'row', width: '100%' }} 
